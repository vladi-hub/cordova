...
Game.prototype = {
  ...
  create: function () {
	...
	this.hud = Phaser.Plugin.HUDManager.create(game, this, 'gemshud',1000);
	...
	this.extraHUD = this.hud.addText(200, 10, 'Bonuses: ', style, 'bonus', this);
    this.game.add.existing(this.extraHUD.text);
...
function spawnBoard() {
    ...
    BOARD_COLS = Math.floor((game.world.width - 100)/ GEM_SIZE_SPACED);
    BOARD_ROWS = Math.floor((game.world.height - 100)/ GEM_SIZE_SPACED);
